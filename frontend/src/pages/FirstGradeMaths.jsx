...
// SAMPLE MATHS WORKSHEETS (Replace with actual files)
const firstGradeMaths = [
  {
    title: "Addition Within 20",
    img: "/worksheets/grade1/maths/addition20.png",
    pdf: "/worksheets/grade1/maths/addition20.pdf",
  },
  {
    title: "Subtraction Within 20",
    img: "/worksheets/grade1/maths/subtraction20.png",
    pdf: "/worksheets/grade1/maths/subtraction20.pdf",
  },
  {
    title: "Count & Write Numbers",
    img: "/worksheets/grade1/maths/count-write.png",
    pdf: "/worksheets/grade1/maths/count-write.pdf",
  },
  {
    title: "Number Comparison (>, <, =)",
    img: "/worksheets/grade1/maths/compare.png",
    pdf: "/worksheets/grade1/maths/compare.pdf",
  },
  {
    title: "Basic Word Problems",
    img: "/worksheets/grade1/maths/word-problems.png",
    pdf: "/worksheets/grade1/maths/word-problems.pdf",
  },
  {
    title: "Shapes & Patterns",
    img: "/worksheets/grade1/maths/shapes-patterns.png",
    pdf: "/worksheets/grade1/maths/shapes-patterns.pdf",
  },
];
...
const FirstGradeMaths = () => {
  ...
  const openPreview = (item) => setPreviewData(item);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-orange-100">
      ...
      <header className="relative pt-28 pb-20 overflow-hidden text-center">
        ...
        <motion.span
          className="absolute right-10 top-32 text-6xl opacity-50 pointer-events-none"
          animate={{ y: [0, -14, 0] }}
          transition={{ duration: 3, repeat: Infinity }}
        >
          ➗
        ...
        >
          1st Grade Maths Worksheets 🧮
        </motion.h1>

        <p className="text-gray-700 text-lg mt-4 max-w-2xl mx-auto">
          Fun maths worksheets covering addition, subtraction, counting,
          word problems, shapes, and more — perfect for young learners!
        </p>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
          {firstGradeMaths.slice(0, visible).map((ws, i) => (
            <motion.div
              key={i}
        ...
        {/* LOAD MORE */}
        {visible < firstGradeMaths.length && (
...
export default FirstGradeMaths;
